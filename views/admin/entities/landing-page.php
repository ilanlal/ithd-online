...
$form_control = new Form_Control(FormConfiguration::LendingPage);

if (!isset($_SESSION[Base_Control::SESSION_ADMIN_EMAIL])) {
    header("Location: " . $form_control->company_path . "/views/admin/user/login#login");
}
...
<html lang="en">
    ...
    <body onload="showLogo()">
        ...
        <article>
            ...
            <section id="form">
				<form action="<?php echo filter_input(INPUT_GET, "id") . "#form"; ?>" method="post">
                    <section>
                    ...
                    <section>
                        <div>
                            <?php if ($form_control->item->strong_id != null): ?>
                                <fieldset>
                                    ...
                                    <div class="field">
                                        ...
                                        . $form_control->form_type . "/" . $form_control->item->strong_id;
                                        ?>">Form URL</a>
                                    </div>
                                    <label>Embedded Code</label>
                                    <textarea><?php
                                        echo '<iframe style="width:350px; height:500px;border:0" '
                                        . 'src="' . ConfigUtils::FullWebHost . '/views/customer/general-forms/' . $form_control->form_type . "/" . $form_control->item->strong_id . '">';
                                        ?>
                                    </textarea>
                            ...
                            <fieldset>
                                 ...
                                 <div class="field">
                                    ...
                                    <input type="text" placeholder=""
                                           name="form_name" value="<?php echo $form_control->item->form_name ?>" 
                                           required />
                                </div>
                            </fieldset>
                            <fieldset>
                                <legend>Transmit Target:</legend>
                                <input type="hidden" name="id" value="<?php echo $form_control->item->strong_id ?>" />
                                ...
                                <div class="field">
                                    ...
                                    <input type="email" placeholder="email@domain.com"
                                           name="user_email" value="<?php echo $form_control->item->user_email ?>" 
                                           required />
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="field">
                                    <input type="checkbox" name="terms" <?php if ($form_control->item->strong_id != null) echo "checked"; ?> required />
                        ...
                        <div>
                            <fieldset>
                                ...
                                <div class="field">
                                    ...
                                    <textarea name="free_title" required><?php echo $form_control->item->free_title ?></textarea>
                                </div>
                                <div class="field">
                                    <label title="The messahe will appear to customer after sumit action" for="thanks_message">Thanks Message:</label>
                                    <textarea name="thanks_message" required><?php echo $form_control->item->thanks_message ?></textarea>
                                </div>
                            </fieldset>
                            <fieldset>
                                ...
                                <div class="field">
                                    ...
                                    <input type="url" id="logo_url" name="logo_url"
                                           ...
                                           value="<?php echo $form_control->item->logo_url ?>"
                                           onchange="showLogo()" >
                                ...
                                <div class="field">
                                    ...
                                    <select name="font_family">
                                        ...
                                        if ($form_control->item->font_family == "cursive") {
                                            echo 'selected';
                                        }
                                        ?> >cursive</option>
                                        <option id="fantasy" <?php
                                        if ($form_control->item->font_family == "fantasy") {
                                            echo 'selected';
                                        }
                                        ?>>fantasy</option>
                                        <option id="monospace" <?php
                                        if ($form_control->item->font_family == "monospace") {
                                            echo 'selected';
                                        }
                                        ?>>monospace</option>
                                        <option id="sans-serif" <?php
                                        if ($form_control->item->font_family == "sans-serif") {
                                            echo 'selected';
                                        }
                                        ?>>sans-serif</option>
                                        <option id="serif" <?php
                                        if ($form_control->item->font_family == "serif") {
                                            echo 'selected';
                                        }
                                        ?>>serif</option>
                                    </select>
                                ...
                                <div class="field">
                                    ...
                                    <select name="font_size">
                                        ...
                                        if ($form_control->item->font_size == "x-large") {
                                            echo 'selected';
                                        }
                                        ?>>x-large</option>
                                        <option id="larger" <?php
                                        if ($form_control->item->font_size == "larger") {
                                            echo 'selected';
                                        }
                                        ?>>larger</option>
                                        <option id="large" <?php
                                        if ($form_control->item->font_size == "large") {
                                            echo 'selected';
                                        }
                                        ?>>large</option>
                                        <option id="medium" <?php
                                        if ($form_control->item->font_size == "medium") {
                                            echo 'selected';
                                        }
                                        ?>>medium</option>
                                        <option id="small" <?php
                                        if ($form_control->item->font_size == "small") {
                                            echo 'selected';
                                        }
                                        ?>>small</option>
                                        <option id="smaller" <?php
                                        if ($form_control->item->font_size == "smaller") {
                                            echo 'selected';
                                        }
                                        ?>>smaller</option>
                                        <option id="x-small" <?php
                                        if ($form_control->item->font_size == "x-small") {
                                            echo 'selected';
                                        }
                                        ?>>x-small</option>
                                        <option id="xx-small" <?php
                                        if ($form_control->item->font_size == "xx-small") {
                                            echo 'selected';
                                        }
                                        ?>>xx-small</option>
                                    </select>
                                ...
                                <div class="field">
                                    ...
                                    <input type="color" name="color" 
                                           value="<?php echo ($form_control->item->color == null ? '#0000FF' : $form_control->item->color) ?>"/>
                                </div>
                                <div class="field">
                                    <label title="The background color of the page" for="color">Back Color:</label>
                                    <input type="color" name="background_color" 
                                           value="<?php echo ($form_control->item->background_color == null ? '#EEEEEE' : $form_control->item->background_color) ?>"/>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="field">
                                    ...
                                    <?php if ($form_control->item->submit_xml == 1) echo 'checked="checked"' ?>
                                           />
                                </div>
                                <div class="field">
                                    <label>JSON Attachment</label>
                                    <input type="checkbox" title="Attach json file to the email" name="submit_json" value="1"
                                    <?php if ($form_control->item->submit_json == 1) echo 'checked="checked"' ?>
                                           />
                                </div>
