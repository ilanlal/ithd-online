...
class Base_Control {
    ...
    public function get_org_id() {
        if(isset($_SESSION[self::SESSION_ORGANIZATION_ID]))
            return $_SESSION[self::SESSION_ORGANIZATION_ID];
    ...
    public function get_org_unique_name() {
        if(isset($_SESSION[self::SESSION_ORGANIZATION_UNIQUE_NAME]))
            return $_SESSION[self::SESSION_ORGANIZATION_UNIQUE_NAME];
    ...
    public function get_current_customer_id() {
        if(isset($_SESSION[self::SESSION_CUSTOMER_ID]))
            return $_SESSION[self::SESSION_CUSTOMER_ID];
